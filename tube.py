...
class Env():
   def __init__(self, timestep=0.002):
        ...
        self.box.add("geom", name="0", friction="0.9", type="box", size=".07 .07 .07", rgba="0 0 1 0.8")
        ...
        for i in range(15):
            ...
            "body", name=f"box_{i}", pos = f"0 {0.15} 0",)
            tempbox2.add("geom", name=f"box_{i}", friction="0.9", type="box", size=".07 .07 .07", rgba="0 0 1 0.8")
            tempbox2.add("joint", name=f"ball_joint_{i}", stiffness="1e2")
            tempbox = tempbox2
